        ...
        <Section background="gradient-secondary">
            <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="text-base md:text-lg text-textLight leading-relaxed mb-xl text-left max-w-2xl mx-auto p-lg bg-white/50 rounded-lg">
                    ...
                    <p className="mb-md">
                        Ao longo dessas duas décadas, desenvolvemos dezenas de produtos com extratos da floresta, sempre buscando o melhor que a natureza pode oferecer. Mas foi quando descobrimos <strong className="text-primary">a dolomita</strong> — um mineral que a natureza criou há milhões de anos, escondido nas profundezas da floresta — que encontramos algo verdadeiramente especial.
                    </p>
                    
                    <p className="mb-md">
                        A dolomita se tornou o coração do nosso <strong className="text-primary">Kit Completo</strong>, combinando toda a experiência de 20 anos em skincare natural com o poder transformador deste mineral único. Não é apenas mais um produto — é o resultado de duas décadas de pesquisa, dedicação e amor pela beleza que vem da floresta.
                    </p>
